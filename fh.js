...
;!function(a) {
    ...
    811: function(e, t) {
        ...
        $(document).off("click", ".create_ticket").on("click", ".create_ticket", function(e) {
            ...
            m(a + "&info=" + (o = btoa(JSON.stringify(o))))
        }),
        $(document).off("click", ".raise_issue_button").on("click", ".raise_issue_button", function(e) {
            ...
            o = $(this).parents(".user-actions").data("tab-id"),
            i = HOST + "clients/merchant_support_create_ticket.php?entity_id=" + a + "&tab_id=" + o,
            r = {
                res_id: a,
                res_name: $(this).attr("res_name"),
                source_app: "merchant web dashboard",
            ...
            m(i + "&info=" + (r = btoa(JSON.stringify(r)))))
        }),
        $(".view_tickets").on("click", function(e) {
            ...
            m(HOST + "clients/merchant_support_view_tickets.php?entity_id=" + t + "?info=" + (a = btoa(JSON.stringify(a))))
        }),
...
!function(r) {
    ...
    12: function(t, f, e) {
        var o, r = e(796), i = e(164), l = e(795), s = e(794), u = e(793);
        "undefined" != typeof ArrayBuffer && (o = e(792));
    ...
    5: function(r, i, n) {
        (function(e) {
            ...
            (i = r.exports = n(803)).log = function() {
 ...
 */
    ...
    806: function(t, e, r) {
        var n, o = r(805), i = (n = o) && n.__esModule ? n : {
            default: n
        };
        function p(t, e, r) {
