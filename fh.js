        ...
        (function(Z) {
            ...
            !function(s, p, a) {
                ...
                _.Class.extend = function(t) {
                    ...
                    var n, o = new i;
                    for (n in (o.constructor = e).prototype = o,
                    this)
                        this.hasOwnProperty(n) && "prototype" !== n && (e[n] = this[n]);
                    t.statics && (_.extend(e, t.statics),
                    delete t.statics),
                    t.includes && (_.Util.extend.apply(null, [o].concat(t.includes)),
                    delete t.includes),
                    t.options && o.options && (t.options = _.extend({}, o.options, t.options)),
                    _.extend(o, t),
                    o._initHooks = [];
                    var s = this;
                ...
                u = "ActiveXObject"in s,
                c = u && !p.addEventListener,
                ...
                _.TileLayer.WMS = _.TileLayer.extend({
                    ...
                    initialize: function(t, e) {
                        this._url = t;
                        var i, n = _.extend({}, this.defaultWmsParams), o = e.tileSize || this.options.tileSize;
                        for (i in e.detectRetina && _.Browser.retina ? n.width = n.height = 2 * o : n.width = n.height = o,
                        e)
                            this.options.hasOwnProperty(i) || "crs" === i || (n[i] = e[i]);
                        this.wmsParams = n,
                        _.setOptions(this, e)
                    },
                    onAdd: function(t) {
                        ...
                        function c(t) {
                            ...
                            if (h) {
                                if (_.Browser.pointer) {
                                    ...
                                    for (n in r)
                                        i = r[n],
                                        o[n] = "function" == typeof i ? i.bind(r) : i;
                                    r = o
                                }
                                r.type = "dblclick",
                                s(r),
...
;!function(a) {
    ...
    961: function(e, t) {
        ...
        $(document).on("zready", function() {
            ...
            setInterval(function() {
                $(".merchant-dashboard-container").find(".runnr_boy_text").each(function() {
                    var e, t = +$(this).attr("data-hvo"), a = "0000-00-00 00:00:00" !== $(this).attr("data-rider_reached_kitchen"), i = +$(this).attr("data-eta"), o = 0;
                    t ? $(this).text("Rider is on his way.") : a ? $(this).html('<div class="zrunnr_symbol">Z</div> Rider - ' + $(this).attr("data-name") + " has arrived. Mobile number - " + $(this).attr("data-phone")) : i ? (e = Math.abs(new Date(1e3 * i) - new Date),
                    o = Math.floor(e / 1e3 / 60),
                    $(this).html('<div class="zrunnr_symbol">Z</div> Rider - ' + $(this).attr("data-name") + " is arriving in " + o + " minutes. Mobile number - " + $(this).attr("data-phone"))) : $(this).html('<div class="zrunnr_symbol">Z</div> Rider - ' + $(this).attr("data-name") + " is on his way. Mobile number - " + $(this).attr("data-phone"))
                })
            }, 1e3)
        });
        var s = window.kptFeatureEnabled;
        ...
        ,
        window.updateOrderData = function(s, n) {
            $.ajax({
                ...
                success: function(e) {
                    if ("success" == e.status) {
                        ...
                        if (!o || "RETURN_INIT" !== o.state && "RETURN_ACK" !== o.state ? -1 != [6, 7, 8].indexOf(i) ? ($('.row.user-actions[data-tab-id="' + s + '"]').remove(),
                        checkEmptyState(),
                        n = !1) : $('.row.user-actions[data-tab-id="' + s + '"]').replaceWith(t) : 0 == $('.row.user-actions[data-tab-id="' + s + '"]').length ? $("#agent-order-list").prepend(t) : $('.row.user-actions[data-tab-id="' + s + '"]').replaceWith(t),
                        1 == window.isModalOpen && window.modalTab == s && (window.newCloseModal(),
                        1 !== i && stopAlertSound()),
                        o && "RETURN_INIT" === o.state)
                            return 0 != window.isModalOpen || 0 != window.isReturnedModalOpen ? window.enQueueReturnedTab(s, a) : window.showReturnedOrderPopup(a, s),
                            !0;
                        if (8 === i && r && o && !o.state) {
                            if (0 != window.isModalOpen || 0 != window.isCancelledModalOpen)
                                return window.enQueueCancelledTab(s, a),
                                !0;
                            window.showCancelledOrderPopup(a, s)
                        }
                        return !0
                    }
                }
            ...
            1 == n && setTimeout(function() {
                window.updateOrderData(s, !1)
            }, 2e3)
        }
        ,
        window.showReturnedOrderPopup = function(r, s) {
            if (window.enQueueReturnedTab(s, r),
        ...
        ,
        window.showCancelledOrderPopup = function(o, r) {
            if (window.enQueueCancelledTab(r, o),
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    var i = _.template($("#cancelledOrderTemplate").html());
                    $("#view-cart-modal").html(i(a)),
                    $("#view-cart-modal").openModal({
                        dismissible: !1
                    }),
                    $("#view-cart-modal").off("click", ".dismissCancelledOrder").on("click", ".dismissCancelledOrder", closeCancelledModal.bind(null, r, o)),
        ...
        window.resActivePolling = function t() {
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    0 < e.polling_frequency && o !== e.polling_frequency && (clearInterval(a),
                    o = e.polling_frequency,
                    a = setInterval(t, o))) : "refresh" == e.status && (alert(e.message),
        ...
        window.disableResActivePolling || (a = setInterval(resActivePolling, o)),
        $(document).off("click", "#filter-orders").on("click", "#filter-orders", function(e) {
            ...
            var t = parseInt($("#city-selector").val())
              ...
              , i = parseInt($("#tl-selector").val())
              , o = parseInt($("#payment-selector").val())
              , r = 0;
            document.getElementById("interval-selector") && (r = parseInt($("#interval-selector").val()));
            var s = [];
            0 != t && s.push("city_id=" + t),
            0 != a && s.push("poc_id=" + a),
            0 != i && s.push("team_lead_id=" + i),
            0 != r && s.push("order_interval=" + r),
            0 != o && s.push("payment_filter=" + o);
            var n = s.join("&");
            "" != n ? document.location.assign(HOST + "admin/tools/ordering.php?" + n) : document.location.assign(HOST + "admin/tools/ordering.php")
        }),
        window.sendActionRequest = function(a, i) {
            var o = a.action
              , r = i.data("tab-id")
              , s = i.data("zomato-fullfilled");
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                data: a,
                ...
                success: function(e) {
                    ...
                    i.removeClass("unanswered"),
                    "decline" == o ? (sendToJumbo("jevent", {
                        ename: "OOS_reject",
                    ...
                    i.remove(),
                    checkEmptyState(),
                    alert(e.message + " " + (e.secondary_message || ""))) : "accept" == o ? (i.find(".accept").remove(),
                    i.find(".reject").remove(),
                    $.ajax({
                        url: "http://localhost/RestoCommonAccess/ZMT?TID=" + a.tab_id,
                        type: "GET",
                        success: console.log("Local Accept Success")
                    }),
                    0 == s && i.find(".dispatch").show()) : "move_to_delivery" == o && (i.find(".dispatch").removeClass("hidden"),
                    i.remove(),
                    checkEmptyState(),
            ...
            "accept" == o && window.updateOrderData(r, !0)
        }
        ,
        ...
        window.timestampToFriendly = function(e) {
            var t, a = "", i = t = 0;
            return 3600 <= e && (e -= 3600 * (i = parseInt(e / 3600, 10))),
        ...
        function r(a, i) {
            return window.delivery_areas.sort(function(e, t) {
                return "asc" === i ? e[a] - t[a] : t[a] - e[a]
            })
        }
        function p() {
            return {
                heading: "Delivery Areas",
                bodyText1: "Manage the locations you would like to deliver to.",
                bodyText2: "Note: The changes are valid for the current day and all areas will get auto-enabled at 6 AM, next business day.",
                searchPlaceholderText: "Search by area name",
                sortByText: "Sort by",
                tierText: "tier",
                disabledText: "areas are currently disabled",
                singleResDisabledText: "area is currently disabled",
                enableAllText: "Enable all",
                viewText: "View",
        ...
        function h(t, a, e) {
            ...
            e.forEach(function(e) {
                i += '<div style="display: flex; flex: 12; border-bottom: 1px solid #EBEBEB; padding: 24px; font-size: 16px;">',
                i += '<div style="flex: 10;">',
                i += e.delivery_subzone_name,
                i += '<div style="font-size: 14px;">' + e.tier_name + " | " + e.distance_display_string + ' | Minimum order:' + e.moa_display_string + "</div>",
                i += "</div>",
                i += '<div style="flex: 2; text-align: end;">',
                i += '<div class="switch col s3">',
                i += "<label>",
                i += '<input class="delivery_area_status_switch" data-delivery_subzone_id="' + e.delivery_subzone_id + '" data-res_id="' + t + '" data-res_name="' + a + '" type="checkbox"',
                e.is_active && (i += "checked"),
                i += ">",
                i += '<span class="lever"></span>',
                i += "</label>",
                i += "</div>",
                i += "</div>",
                i += "</div>"
            }),
            $("#searched_delivery_areas").html(i)
        }
        function f(e) {
        ...
        window.addDialogEventsRej = function() {
            ...
            var s, n, r = $(".modal .confirm-reject"), a = r.data("tab-id"), e = {
                tab_id: a,
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    t.trigger("change");
                    var i = getRejectionPenalty(n, s);
                    a.data("penaltyAmount", m(i, "penalty_amount", 0));
                    var o = '<div class="zred"><b>' + m(i, "message.penalty_amount_message", "") + "</b></div>"
                      , r = '<div class="grey-text">' + m(i, "message.penalty_time_message", "") + "</div>";
                    a.html("<div>" + o + r + "</div>")
                }
            }),
            $.ajax({
        ...
        window.addDialogEventsAcc = function() {
            ...
            var e, t, a = $(".confirm-accept").data("avg-time"), i = $(".confirm-accept").data("tab-id"), o = parseInt($("#time-selector").data("logistics-partner-id"));
            a = 0 == o ? (t = e = a,
            ...
            var r, s = $("#time-selector option[value=" + a + "]");
            0 == s.length ? (r = 0 < o ? 15 : 30,
            sendToJumbo("jevent", {
            ...
            $(".modal").off("click", ".confirm-accept").on("click", ".confirm-accept", function(e) {
                var t = $(".primary-comment").val()
                  ...
                  , i = $("#response-selector").find(":selected").val()
                  , o = $("#time-selector").find(":selected").val()
                  , r = {
                    action: "accept",
                    tab_id: a,
                    delivery_time: o,
        ...
        window.addActionButtonEvent = function() {
            ...
            $(this).hasClass("reject")) {
                ...
                return $("#reject-order-modal").html(a(o)),
            ...
            i = $("#res_id").data("delivery_subzone_id"),
            o.avg_time = $(this).data("avg-time"),
            o.delivery_by_zomato = $(this).data("zomato-fullfilled"),
            o.displayed_kpt = $(this).data("displayed-kpt"),
            o.is_kpt_feature_enabled = s[e],
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                data: {
                    ...
                    res_id: e,
                    delivery_subzone_id: i
                },
                success: function(e) {
                    return o.deliveryMode = r,
                    o.is_surge_applied = e.is_surge_applied,
                    o.delivery_time = e.delivery_time,
                    o.res_support_tier_wise_ddt = e.res_support_tier_wise_ddt,
                    o.res_takeaway_kpt = e.res_takeaway_kpt,
                    $("#accept-order-modal").html(a(o)),
            ...
            $(this).hasClass("accept") || sendActionRequest(o, t)
        }
        ,
        ...
        window.bindDialogActionEvents = function() {
            ...
            $(document).off("click", "#viewAddrOnMap").on("click", "#viewAddrOnMap", function() {
                ...
                $("#nonlogs_location-modal").html(r(o)),
        ...
        window.addDispatchEvent = function() {
            $(document).off("click", ".dispatch").on("click", ".dispatch", function(e) {
                var t = (i = $(this).parents(".user-actions")).data("tab-id")
                  , a = {
                    tab_id: t,
                    method: "deliverytabresponse",
                  ...
                  , i = $('[data-tab-id="' + t + '"]');
                sendActionRequest(a, i),
                stopAlertSound()
            })
        }
        ,
        $(document).on("change", ".self_delivery_status_switch", function() {
            var e, t, a = $(this), i = a.data("res-id"), o = (a.data("res-name"),
            a.is(":checked") ? 1 : 0);
            0 == o ? (e = _.template($("#statusSelfDeliveryTimeTemplate").html()),
            t = {
                res_id: i,
                self_delivery_status: o,
                localizedTexts: {
        ...
        $(document).on("change", ".delivery_status_switch", function() {
            var e, t, i = $(this).data("res-id"), o = $(this).is(":checked") ? 1 : 0;
            0 == o ? (e = _.template($("#statusTimeTemplate").html()),
            t = {
                res_id: i,
                delivery_status: o,
                localizedTexts: {
                ...
                success: function(e) {
                    "success" === e.status && $.ajax({
                        ...
                        success: function(e) {
                            ...
                            t = (t = "#surge_timings_").concat(i),
                            a = "#surge_status_".concat(i),
                            o ? e.surge_status ? ($(a).show(),
                            $(t).hide()) : ($(t).show(),
                            $(a).hide()) : ($(a).hide(),
                            $(t).hide()))
                        }
        ...
        $(document).off("click", ".create_ticket").on("click", ".create_ticket", function(e) {
            e.preventDefault();
            var t = $(this).attr("res_id")
              , a = HOST + "clients/merchant_support_create_ticket.php?entity_id=" + t
              , i = {
                res_id: t,
            ...
            f(a + "&info=" + (i = btoa(JSON.stringify(i))))
        }),
        $(document).off("click", ".raise_issue_button").on("click", ".raise_issue_button", function(e) {
            ...
            alert(t)) : (a = $(this).attr("res_id"),
            i = $(this).parents(".user-actions").data("tab-id"),
            o = HOST + "clients/merchant_support_create_ticket.php?entity_id=" + a + "&tab_id=" + i,
            r = {
                res_id: a,
                res_name: $(this).attr("res_name"),
                source_app: "merchant web dashboard",
            ...
            f(o + "&info=" + (r = btoa(JSON.stringify(r)))))
        }),
        $(".view_tickets").on("click", function(e) {
            ...
            f(HOST + "clients/merchant_support_view_tickets.php?entity_id=" + t + "?info=" + (a = btoa(JSON.stringify(a))))
        }),
        $(document).on("change", ".delivery_area_status_switch", function() {
            var e = $(this)
              , s = e.data("res_id")
              , n = e.data("res_name")
              , d = e.data("delivery_subzone_id")
              , l = !!e.is(":checked");
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                data: {
                    method: "update_delivery_areas",
                    res_id: s,
                ...
                success: function(e) {
                    var t, a, i, o, r;
                    "success" === e.status ? (t = (i = window.delivery_areas.map(function(e) {
                        return e.delivery_subzone_id == d ? c({}, e, {
                            is_active: l
                        }) : e
                    })).filter(function(e) {
                        return !e.is_active
                    }),
                    window.delivery_areas = i,
                    window.disabled_areas = t,
                    a = i.filter(function(e) {
                        return e.tier_entity_id == window.tier_id_selected
                    }),
                    o = {
                        delivery_areas: i = window.tier_id_selected && "0" != window.tier_id_selected ? a : i,
                        disabled_areas_count: t.length,
                        search_text: "",
                        tier_id_selected: window.tier_id_selected ? window.tier_id_selected : "",
                        sort_by_id_selected: window.sort_by_id_selected ? window.sort_by_id_selected : "",
                        tiers: tiers,
                        is_view_clicked: 0,
                        res_name: n,
                        res_id: s
                    },
                    r = _.template($("#delivery_area_template").html()),
                    o.localizedTexts = p(),
                    $("#delivery-area-modal").html(r(o))) : alert("Something went wrong, please try again.")
                }
            })
        }),
        $(document).on("change", ".payment_option_status_switch", function() {
            var e = $(this)
              , o = e.data("res_id")
              , r = e.data("res_name")
              , s = e.data("payment_method_id")
              , t = e.data("payment_method_type")
              , n = e.is(":checked") ? 1 : 0;
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                ...
                success: function(e) {
                    var t, a, i;
                    "success" === e.status ? (t = window.payment_methods.map(function(e) {
                        return e.payment_method_id == s ? c({}, e, {
                            checked: n
                        }) : e
                    }),
                    window.payment_methods = t,
                    a = _.template($("#payment_options_template").html()),
                    i = {
                        payment_methods: t,
                        res_name: r,
                        res_id: o,
                        localizedTexts: {
                            ...
                            bodyText1: "Manage the payment options shown to customers.",
                            bodyText2: "Note: Online credit/debit card and Cash-on-delivery payments cannot be disabled as they are mandatory."
                        }
                    },
                    $("#payment-options-modal").html(a(i))) : alert("Something went wrong, please try again.")
                }
            })
        }),
        $(".delivery_area").on("click", function(e) {
            e.preventDefault();
            var o = $(this).attr("res_id")
              , r = $(this).attr("res_name");
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                data: {
                    method: "get_delivery_areas",
                    res_id: o,
                    logistic_partner_id: 0
                },
                success: function(e) {
                    var t, a, i;
                    "success" === e.status && e.dszs && 0 < e.dszs.length && (t = e.dszs.filter(function(e) {
                        return !e.is_active
                    }),
                    window.delivery_areas = e.dszs,
                    window.disabled_areas = t,
                    window.tiers = e.tiers,
                    window.sortBy = [{
                        entity_id: 1,
                        name: "Distance - Near to far"
                    }, {
                        entity_id: 2,
                        name: "Distance - Far to near"
                    }, {
                        entity_id: 3,
                        name: "Minimum order - Low to high"
                    }, {
                        entity_id: 4,
                        name: "Minimum order - High to low"
                    }],
                    a = {
                    ...
                    i = _.template($("#delivery_area_template").html()),
                    a.localizedTexts = p(),
                    $("#delivery-area-modal").html(i(a)),
                    $("#delivery-area-modal").openModal())
                }
            })
        }),
        $(".payment_options").on("click", function(e) {
            e.preventDefault();
            var i = $(this).attr("res_id")
              , o = $(this).attr("res_name");
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                data: {
                ...
                success: function(e) {
                    var t, a;
                    "success" === e.status && e.payment_methods && 0 < e.payment_methods.length && (t = _.template($("#payment_options_template").html()),
                    a = {
                        payment_methods: e.payment_methods,
                        res_name: o,
                        res_id: i
                    },
                    window.payment_methods = e.payment_methods,
                    a.localizedTexts = {
                        heading: "Payment Options",
                        bodyText1: "Manage the payment options shown to customers.",
                        bodyText2: "Note: Online credit/debit card and Cash-on-delivery payments cannot be disabled as they are mandatory."
                    },
                    $("#payment-options-modal").html(t(a)),
                    $("#payment-options-modal").openModal())
                }
            })
        }),
        $(document).on("click", "#delivery_area_modal_cross", function(e) {
            e.preventDefault(),
            $("#delivery-area-modal").closeModal()
        }),
        $(document).on("click", "#payment_options_modal_cross", function(e) {
            e.preventDefault(),
            $("#payment-options-modal").closeModal()
        }),
        $(document).on("change", "#delivery_area_sort_by_filter", function(e) {
            e.preventDefault();
            var t = $(this).val()
              , a = $(this).data("res_id")
              , i = $(this).data("res_name");
            window.sort_by_id_selected = t,
            $("#delivery_area_tier_filter").val(""),
            window.tier_id_selected = "",
            h(a, i, function(e) {
                switch (window.delivery_areas,
                e) {
                case "1":
                    return r("distance", "asc");
                case "2":
                    return r("distance", "desc");
                case "3":
                    return r("minimum_order_amount", "asc");
                case "4":
                    return r("minimum_order_amount", "desc");
                default:
                    return window.delivery_areas
                }
            }(t))
        }),
        $(document).on("change", "#delivery_area_tier_filter", function(e) {
            e.preventDefault();
            var t = $(this).val()
              , a = $(this).data("res_id")
              , i = $(this).data("res_name");
            window.tier_id_selected = t,
            $("#delivery_area_sort_by_filter").val(""),
            window.sort_by_id_selected = "";
            var o = window.delivery_areas.filter(function(e) {
                return e.tier_entity_id == t
            });
            h(a, i, t && "0" != t ? o : window.delivery_areas)
        }),
        $(document).on("keyup", "#delivery_areas_search", function(e) {
            e.preventDefault();
            var t = $(this).val();
            h($(this).data("res_id"), $(this).data("res_name"), window.delivery_areas.filter(function(e) {
                return -1 < e.delivery_subzone_name.toLowerCase().indexOf(t)
            }))
        }),
        $(document).on("click", "#disabled_area_back_button", function(e) {
            e.preventDefault();
            var t = $(this).data("res_id")
              , a = $(this).data("res_name")
              , i = {
                delivery_areas: window.delivery_areas,
                disabled_areas_count: window.disabled_areas.length,
                search_text: "",
                tier_id_selected: "",
                sort_by_id_selected: "",
                tiers: window.tiers,
              ...
              , o = _.template($("#delivery_area_template").html());
            i.localizedTexts = p(),
            $("#delivery-area-modal").html(o(i))
        }),
        $(document).on("click", "#disabled_areas_view", function(e) {
            e.preventDefault();
            var t = $(this).data("res_id")
              , a = $(this).data("res_name")
              , i = {
                delivery_areas: window.disabled_areas,
                disabled_areas_count: window.disabled_areas.length,
                search_text: "",
                tier_id_selected: "",
                sort_by_id_selected: "",
        ...
        $(document).on("click", "#disabled_areas_enable_all", function(e) {
            e.preventDefault();
            var s = $(this).data("res_id")
              , n = $(this).data("res_name")
              , t = window.disabled_areas.map(function(e) {
                return e.delivery_subzone_id
            });
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                ...
                success: function(e) {
                    var t, a, i, o, r;
                    "success" === e.status ? (t = window.delivery_areas.map(function(e) {
                        return c({}, e, {
                            is_active: !0
                        })
                    }),
                    a = window.disabled_areas.map(function(e) {
                        return c({}, e, {
                            is_active: !0
                        })
                    }),
                    ...
                    window.delivery_areas = t,
                    o = {
                        delivery_areas: a,
                        disabled_areas_count: (window.disabled_areas = i).length,
                        search_text: "",
                        tier_id_selected: "",
                        sort_by_id_selected: "",
                        tiers: window.tiers,
        ...
        window.changeSelfDeliveryBannerText = function() {
            ...
            for (e in d)
                d[e] || (a = i[e],
                t++);
            0 < t ? 1 === t ? $("#self_delivery_banner").show().text("Self Delivery Off - " + a) : $("#self_delivery_banner").show().text("Self Delivery Off - " + t + " Outlets") : $("#self_delivery_banner").hide()
        }
        ,
        window.bindDeliveryStatusUpdateEvents = function() {
            ...
            $(".modal").off("click", ".delivery_status_button").on("click", ".delivery_status_button", function() {
                ...
                $(".delivery_status_switch").each(function() {
                    ...
                    i = $("#delivery_time_" + e).val(),
                    o = $("#surge_duration_" + e).val()) : $(t).is(":visible") && (a = 1,
                    i = $("#tier_delivery_time_" + e).val(),
                    o = $("#tier_surge_duration_" + e).val());
                    var r = {};
                    r.surge_status = a,
                    r.delivery_time = i,
                    r.surge_duration = o,
            ...
            $.ajax({
                ...
                success: function(e) {
                    if ("success" === e.status) {
                        var t = $.parseJSON(e.takeaway_is_active)
                          ...
                          , e = {
                            ...
                            showPickup: function(e) {
                                var t, a = !1;
                                for (t in e)
                                    e.hasOwnProperty(t) && Boolean(e[t]) && (a = !0);
                                return a
                            }(t)
                        };
                        ...
                        var i = _.template($("#deliveryStatusTemplate").html());
                        $("#delivery-status-modal").html(i(e)),
                        $("#delivery-status-modal").openModal({
                            ready: bindDeliveryStatusUpdateEvents,
                            complete: window.newCloseModal
                        }),
                        window.isModalOpen = 1;
                        for (var o = "#surge_timings_", r = "#surge_status_", s = resIdsList.length - 1; 0 <= s; s--)
                            e.delivery_status_list[resIdsList[s]] ? a[resIdsList[s]] ? ($(o.concat(resIdsList[s])).hide(),
                            $(r.concat(resIdsList[s])).show()) : ($(o.concat(resIdsList[s])).show(),
                            $(r.concat(resIdsList[s])).hide()) : ($(o.concat(resIdsList[s])).hide(),
                            $(r.concat(resIdsList[s])).hide());
                        $(".see_full_list").each(function() {
                            var e, t = $(this).html().trim();
                            75 < (t = t.replace(/  /g, "")).length && (e = t.substr(0, 75) + '<span class="moreellipses">...&nbsp;</span><span class="morecontent"><span>' + t.substr(75, t.length - 75) + '</span>&nbsp;&nbsp;<a href="" class="morelink" style="text-align: right;padding-right: 10px;">' + n + "</a></span>",
                            $(this).html(e))
                        }),
                        $(".morelink").click(function() {
                            return $(this).hasClass("less") ? ($(this).removeClass("less"),
                            $(this).html(n)) : ($(this).addClass("less"),
                            $(this).html("Show less")),
        ...
        $(document).off("click", ".view-cart").on("click", ".view-cart", function() {
            var r = $(this).data("res_id")
              , s = $(this).parents(".user-actions").data("tab-id");
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                data: {
        ...
        window.mapApi = function(l, e) {
            ...
            i = (a = "https://maps.zomato.com/") + "osm/{z}/{x}/{y}.png",
            1.5 < window.devicePixelRatio && (i = a + "osm_retina/{z}/{x}/{y}.png"),
            L.tileLayer(i, {
                detectRetina: !0
            }).addTo(map),
            c = {},
            ...
            p = function(e, t) {
                var a = e
                  ...
                  , o = new L.latLng(parseFloat(t[e][1]),parseFloat(t[e][2]));
                return markerPos = L.marker(o, {
                    icon: i,
                    title: t[e][4]
                }),
                ...
                $.ajax({
                    ...
                    success: function(e) {
                        ...
                        var t = ["rider", parseFloat(e.rider.latitude), parseFloat(e.rider.longitude), CDN + "images/bike_small.png", "Rider"]
                          ...
                          , i = [t, ["rest", parseFloat(l.res_latitude), parseFloat(l.res_longitude), CDN + "images/restaurant_marker_v2.svg", "Restaurant"], a];
                        $("#riderMapLink").attr("href", "https://www.google.com/maps/dir/?api=1&origin=" + i[0][1] + "," + i[0][2] + "&destination=" + i[2][1] + "," + i[2][2] + "&travelmode=driving&waypoints=" + i[1][1] + "," + i[1][2]);
                        for (var o, r = 0; r < i.length; r++)
                            "rider" === i[r][0] ? (o = void 0,
                            (o = c[r]) && map.removeLayer(o),
                            p(r, i)) : c[r] || p(r, i);
                        var s = L.latLngBounds(m[0], m[2]);
                        u || map.fitBounds(s, {
                            padding: [50, 50]
                        }),
                        d && (u = setTimeout(n, 1e3 * d))
                    }
                })
            }(),
            "nonlogs" === e && function() {
        ...
        window.createDefaultBanners = function e(t) {
            var a, i = t.pop();
            i && (a = _.template($("#def_banner_tmpl").html()),
            ...
            modalCnt.html(a({
                ...
                action_btn_lbl: i.action_btn_lbl,
                reject_btn_lbl: i.reject_btn_lbl
            })),
            modalCnt.openModal({
        ...
        $(document).off("click", ".runnr_location").on("click", ".runnr_location", function() {
            var e = $(this).data("res_id")
              ...
              , i = $(this).data("delivery_boy_number")
              , o = $(this).data("order_prep_time")
              , r = $(this).data("res_latitude")
              , s = $(this).data("res_longitude")
              , n = $(this).data("delivery_latitude")
        ...
        window.getRejectMessage = function(i) {
            var e = (i = $(i)).parents(".user-actions");
            $.ajax({
                url: HOST + "php/ordering_dashboard.php",
                type: "POST",
                data: {
                ...
                success: function(e) {
                    var t, a = '<select class="reject-reasons">';
                    for (t in e)
                        a += '<option data-msg_id="' + e[t].id + '">' + e[t].text + "</option>";
                    a += "</select>",
                    i.before(a),
                    i.html("Confirm Reject Reason"),
                    i.addClass("reject-msg-sel")
                }
            })
        }
        ,
        window.showPhoneNumber = function(t, a, i) {
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                data: {
                ...
                success: function(e) {
                    ...
                    t.remove(),
                    "OOS_call_customer" === i && sendToJumbo("jevent", {
                        ename: i,
                        var1: $("#res_id").data("res_id"),
                        var2: a,
                        var3: "MERCHANT_WEB"
        ...
        window.getRejectionPenalty = function(e, t) {
            var a, i = Math.floor((Date.now() - new Date(t).getTime()) / 1e3), o = {};
            for (a in e) {
                var r = e[a];
                +r.start_duration <= i && +r.end_duration > i && (o = r)
            }
            return o
        }
        ,
        window.confirmOrderRejection = function(e) {
            ...
            t.html("<div>" + _.values(m(e, "message", [])).join(", ") + "</div>"),
            window.isModalOpen = 1,
            !0
        }
        ,
        window.submitRBTData = function(e, t, a, i, o, r) {
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                async: !1,
                ...
                success: function(e) {
                    ...
                    o()) : "failed" == e.status && (console.log(e.message),
                    r())
                }
            })
        }
        ...
        window.sendRBTFeverData = function() {
            var a = window.rbtTargetEl
              , i = parseFloat($(".rbt-temp-val").text())
            ...
            var o = 99 < i;
            window.submitRBTData(e, o, i, t, function() {
                var e, t;
                $(a).parent().parent().hide(),
                99 < i ? $(a).parent().parent().parent().find(".rbt-negative-flow").show() : ($(a).parent().parent().parent().find(".rbt-happy-flow").show(),
        ...
        window.changeRbtTemp = function(e, t) {
            var a = e.target
              , i = $(a).parent().find(".rbt-temp-val");
            window.rbtValEl = i;
            var o = parseFloat(parseFloat(i.text()) + t).toFixed(1)
              , o = Math.min(Math.max(o, 95), 103);
            i.html(o)
        }
        ,
        ...
        function v(e, t) {
            var a = e.target
              , i = $(a).parent().parent().parent().parent().attr("data-tab_id");
            $.ajax({
                url: HOST + "php/merchant_ordering_dashboard.php",
                type: "POST",
                async: !1,
        ...
        window.redirectToNewDashboard = function() {
            window.open("https://www.zomato.com/partners/onlineordering", "_blank")
        }
    }
});
;//     Underscore.js 1.7.0
...
!function(r) {
    ...
    103: function(t, f, e) {
        var o, r = e(946), i = e(303), l = e(945), s = e(944), u = e(943);
        "undefined" != typeof ArrayBuffer && (o = e(942));
 ...
 */
            ...
            function w(t, e, r) {
                ...
                return function(t) {
                    ...
                    var r = ""
                      , n = 0;
                    for (; n < e; )
                        r += String.fromCharCode.apply(String, t.slice(n, n += v));
                    return r
                }(n)
            }
            I.Buffer = h,
            ...
            h.alloc = function(t, e, r) {
                ...
                s = r,
                u(o = t),
                !(o <= 0) && void 0 !== i ? "string" == typeof s ? c(n, o).fill(i, s) : c(n, o).fill(i) : c(n, o);
                var n, o, i, s
            }
            ,
            ...
            h.prototype.toString = function() {
                var t = 0 | this.length;
                return 0 == t ? "" : 0 === arguments.length ? w(this, 0, t) : e.apply(this, arguments)
            }
            ,
    ...
    300: function(t, e, r) {
        var o = r(287)
          ...
          , s = r(299)
          , a = r(298)
          , c = r(82)("socket.io-client:socket")
          , u = r(258)
          , p = r(303);
        t.exports = l;
        var h = {
    ...
    304: function(t, e, r) {
        var n = r(285)
          ...
          , s = r(257)
          , a = r(302)
          , c = r(82)("engine.io-client:polling");
        t.exports = p;
        var u = null != new (r(286))({
            xdomain: !1
        }).responseType;
        function p(t) {
    ...
    306: function(t, e, r) {
        var c = r(950)
          ...
          , u = r(299)
          , s = r(298)
          , p = r(82)("socket.io-client:manager")
          , a = r(301)
          , h = r(936)
    ...
    82: function(r, i, n) {
        (function(e) {
            ...
            (i = r.exports = n(953)).log = function() {
    ...
    939: function(h, t, f) {
        (function(i) {
            var e, r = f(285), s = f(103), n = f(258), t = f(257), o = f(302), a = f(82)("engine.io-client:websocket"), c = i.WebSocket || i.MozWebSocket;
    ...
    946: function(t, e) {
        t.exports = Object.keys || function(t) {
            var e, r = [], n = Object.prototype.hasOwnProperty;
            for (e in t)
                n.call(t, e) && r.push(e);
            return r
        }
    ...
    947: function(p, t, h) {
        (function(o) {
            var i = h(286)
              ...
              , t = h(105)
              , e = h(257)
              , s = h(82)("engine.io-client:polling-xhr");
            function r() {}
            function a(t) {
                var e, r;
                n.call(this, t),
    ...
    949: function(e, t, r) {
        (function(n) {
            var o = r(305)
              , t = r(105)
              , h = r(82)("engine.io-client:socket")
              , i = r(301)
              , s = r(103)
              , a = r(308)
              , c = r(258);
    ...
    956: function(t, e, r) {
        var n, o = r(955), i = (n = o) && n.__esModule ? n : {
            default: n
        };
        function p(t, e, r) {
